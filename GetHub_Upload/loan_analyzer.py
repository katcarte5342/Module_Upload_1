...
average_amount = sum(loan_costs) / len(loan_costs)
print("The average is $" , (average_amount))
...
present_value = future_value / (1 + (discounted_rate/12)) ** remaining_months
...
if present_value > loan_price:
    print("Buy this house! Loan is worth at least the cost to buy it.")

elif present_value < loan_price:
    print("Do not buy this house. Loan is too expensive and not worth the price.")
...
csvpath = Path("small_value_loans.csv")
